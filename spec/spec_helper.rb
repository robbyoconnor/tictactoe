...
require 'conditions/column_win_condition'
require 'conditions/row_win_condition'
require 'conditions/minor_diagonal_win_condition'
require 'conditions/main_diagonal_win_condition'
require 'strategies/corner_move_computer_strategy'
require 'strategies/random_location_computer_strategy'
